...
from .views import base,suggestions_view, load_in_db,clear , select_arret, home, load_patterns, download_file, get_choice,load_all,previous_suggestion
urlpatterns = [
    path("", home, name="home"),
    ...
    path("suggestions/<slug>/<selected>", suggestions_view.as_view(), name="suggestions"),
